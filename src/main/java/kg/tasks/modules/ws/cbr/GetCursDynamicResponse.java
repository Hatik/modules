...
public class GetCursDynamicResponse  implements java.io.Serializable {
    private kg.tasks.modules.ws.cbr.GetCursDynamicResponseGetCursDynamicResult getCursDynamicResult;

    public GetCursDynamicResponse() {
    }

    public GetCursDynamicResponse(
           kg.tasks.modules.ws.cbr.GetCursDynamicResponseGetCursDynamicResult getCursDynamicResult) {
     ...
     */
    public kg.tasks.modules.ws.cbr.GetCursDynamicResponseGetCursDynamicResult getGetCursDynamicResult() {
        return getCursDynamicResult;
    }
     ...
     */
    public void setGetCursDynamicResult(kg.tasks.modules.ws.cbr.GetCursDynamicResponseGetCursDynamicResult getCursDynamicResult) {
        this.getCursDynamicResult = getCursDynamicResult;
    }
