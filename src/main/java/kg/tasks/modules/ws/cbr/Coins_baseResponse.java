...
public class Coins_baseResponse  implements java.io.Serializable {
    private kg.tasks.modules.ws.cbr.Coins_baseResponseCoins_baseResult coins_baseResult;

    public Coins_baseResponse() {
    }

    public Coins_baseResponse(
           kg.tasks.modules.ws.cbr.Coins_baseResponseCoins_baseResult coins_baseResult) {
     ...
     */
    public kg.tasks.modules.ws.cbr.Coins_baseResponseCoins_baseResult getCoins_baseResult() {
        return coins_baseResult;
    }
     ...
     */
    public void setCoins_baseResult(kg.tasks.modules.ws.cbr.Coins_baseResponseCoins_baseResult coins_baseResult) {
        this.coins_baseResult = coins_baseResult;
    }
