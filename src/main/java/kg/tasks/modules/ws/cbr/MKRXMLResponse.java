...
public class MKRXMLResponse  implements java.io.Serializable {
    private kg.tasks.modules.ws.cbr.MKRXMLResponseMKRXMLResult MKRXMLResult;

    public MKRXMLResponse() {
    }

    public MKRXMLResponse(
           kg.tasks.modules.ws.cbr.MKRXMLResponseMKRXMLResult MKRXMLResult) {
     ...
     * @return MKRXMLResult
     */
    public kg.tasks.modules.ws.cbr.MKRXMLResponseMKRXMLResult getMKRXMLResult() {
        return MKRXMLResult;
    }
     ...
     * @param MKRXMLResult
     */
    public void setMKRXMLResult(kg.tasks.modules.ws.cbr.MKRXMLResponseMKRXMLResult MKRXMLResult) {
        this.MKRXMLResult = MKRXMLResult;
    }
