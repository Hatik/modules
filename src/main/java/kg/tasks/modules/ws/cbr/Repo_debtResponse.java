...
public class Repo_debtResponse  implements java.io.Serializable {
    private kg.tasks.modules.ws.cbr.Repo_debtResponseRepo_debtResult repo_debtResult;

    public Repo_debtResponse() {
    }

    public Repo_debtResponse(
           kg.tasks.modules.ws.cbr.Repo_debtResponseRepo_debtResult repo_debtResult) {
     ...
     */
    public kg.tasks.modules.ws.cbr.Repo_debtResponseRepo_debtResult getRepo_debtResult() {
        return repo_debtResult;
    }
     ...
     */
    public void setRepo_debtResult(kg.tasks.modules.ws.cbr.Repo_debtResponseRepo_debtResult repo_debtResult) {
        this.repo_debtResult = repo_debtResult;
    }
