...
public class Repo_debtXMLResponse  implements java.io.Serializable {
    private kg.tasks.modules.ws.cbr.Repo_debtXMLResponseRepo_debtXMLResult repo_debtXMLResult;

    public Repo_debtXMLResponse() {
    }

    public Repo_debtXMLResponse(
           kg.tasks.modules.ws.cbr.Repo_debtXMLResponseRepo_debtXMLResult repo_debtXMLResult) {
     ...
     */
    public kg.tasks.modules.ws.cbr.Repo_debtXMLResponseRepo_debtXMLResult getRepo_debtXMLResult() {
        return repo_debtXMLResult;
    }
     ...
     */
    public void setRepo_debtXMLResult(kg.tasks.modules.ws.cbr.Repo_debtXMLResponseRepo_debtXMLResult repo_debtXMLResult) {
        this.repo_debtXMLResult = repo_debtXMLResult;
    }
