...
public class ROISfixXMLResponse  implements java.io.Serializable {
    private kg.tasks.modules.ws.cbr.ROISfixXMLResponseROISfixXMLResult ROISfixXMLResult;

    public ROISfixXMLResponse() {
    }

    public ROISfixXMLResponse(
           kg.tasks.modules.ws.cbr.ROISfixXMLResponseROISfixXMLResult ROISfixXMLResult) {
     ...
     */
    public kg.tasks.modules.ws.cbr.ROISfixXMLResponseROISfixXMLResult getROISfixXMLResult() {
        return ROISfixXMLResult;
    }
     ...
     */
    public void setROISfixXMLResult(kg.tasks.modules.ws.cbr.ROISfixXMLResponseROISfixXMLResult ROISfixXMLResult) {
        this.ROISfixXMLResult = ROISfixXMLResult;
    }
