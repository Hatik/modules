...
public class SwapDynamicResponse  implements java.io.Serializable {
    private kg.tasks.modules.ws.cbr.SwapDynamicResponseSwapDynamicResult swapDynamicResult;

    public SwapDynamicResponse() {
    }

    public SwapDynamicResponse(
           kg.tasks.modules.ws.cbr.SwapDynamicResponseSwapDynamicResult swapDynamicResult) {
     ...
     */
    public kg.tasks.modules.ws.cbr.SwapDynamicResponseSwapDynamicResult getSwapDynamicResult() {
        return swapDynamicResult;
    }
     ...
     */
    public void setSwapDynamicResult(kg.tasks.modules.ws.cbr.SwapDynamicResponseSwapDynamicResult swapDynamicResult) {
        this.swapDynamicResult = swapDynamicResult;
    }
