...
public class GetCursOnDateXMLResponse  implements java.io.Serializable {
    private kg.tasks.modules.ws.cbr.GetCursOnDateXMLResponseGetCursOnDateXMLResult getCursOnDateXMLResult;

    public GetCursOnDateXMLResponse() {
    }

    public GetCursOnDateXMLResponse(
           kg.tasks.modules.ws.cbr.GetCursOnDateXMLResponseGetCursOnDateXMLResult getCursOnDateXMLResult) {
     ...
     */
    public kg.tasks.modules.ws.cbr.GetCursOnDateXMLResponseGetCursOnDateXMLResult getGetCursOnDateXMLResult() {
        return getCursOnDateXMLResult;
    }
     ...
     */
    public void setGetCursOnDateXMLResult(kg.tasks.modules.ws.cbr.GetCursOnDateXMLResponseGetCursOnDateXMLResult getCursOnDateXMLResult) {
        this.getCursOnDateXMLResult = getCursOnDateXMLResult;
    }
