...
public class SwapMonthTotalResponse  implements java.io.Serializable {
    private kg.tasks.modules.ws.cbr.SwapMonthTotalResponseSwapMonthTotalResult swapMonthTotalResult;

    public SwapMonthTotalResponse() {
    }

    public SwapMonthTotalResponse(
           kg.tasks.modules.ws.cbr.SwapMonthTotalResponseSwapMonthTotalResult swapMonthTotalResult) {
     ...
     */
    public kg.tasks.modules.ws.cbr.SwapMonthTotalResponseSwapMonthTotalResult getSwapMonthTotalResult() {
        return swapMonthTotalResult;
    }
     ...
     */
    public void setSwapMonthTotalResult(kg.tasks.modules.ws.cbr.SwapMonthTotalResponseSwapMonthTotalResult swapMonthTotalResult) {
        this.swapMonthTotalResult = swapMonthTotalResult;
    }
