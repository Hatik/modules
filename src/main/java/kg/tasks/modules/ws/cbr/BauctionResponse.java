...
public class BauctionResponse  implements java.io.Serializable {
    private kg.tasks.modules.ws.cbr.BauctionResponseBauctionResult bauctionResult;

    public BauctionResponse() {
    }

    public BauctionResponse(
           kg.tasks.modules.ws.cbr.BauctionResponseBauctionResult bauctionResult) {
     ...
     */
    public kg.tasks.modules.ws.cbr.BauctionResponseBauctionResult getBauctionResult() {
        return bauctionResult;
    }
     ...
     */
    public void setBauctionResult(kg.tasks.modules.ws.cbr.BauctionResponseBauctionResult bauctionResult) {
        this.bauctionResult = bauctionResult;
    }
