...
public class OstatDynamicXMLResponse  implements java.io.Serializable {
    private kg.tasks.modules.ws.cbr.OstatDynamicXMLResponseOstatDynamicXMLResult ostatDynamicXMLResult;

    public OstatDynamicXMLResponse() {
    }

    public OstatDynamicXMLResponse(
           kg.tasks.modules.ws.cbr.OstatDynamicXMLResponseOstatDynamicXMLResult ostatDynamicXMLResult) {
     ...
     */
    public kg.tasks.modules.ws.cbr.OstatDynamicXMLResponseOstatDynamicXMLResult getOstatDynamicXMLResult() {
        return ostatDynamicXMLResult;
    }
     ...
     */
    public void setOstatDynamicXMLResult(kg.tasks.modules.ws.cbr.OstatDynamicXMLResponseOstatDynamicXMLResult ostatDynamicXMLResult) {
        this.ostatDynamicXMLResult = ostatDynamicXMLResult;
    }
