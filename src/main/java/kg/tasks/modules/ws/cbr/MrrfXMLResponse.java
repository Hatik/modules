...
public class MrrfXMLResponse  implements java.io.Serializable {
    private kg.tasks.modules.ws.cbr.MrrfXMLResponseMrrfXMLResult mrrfXMLResult;

    public MrrfXMLResponse() {
    }

    public MrrfXMLResponse(
           kg.tasks.modules.ws.cbr.MrrfXMLResponseMrrfXMLResult mrrfXMLResult) {
     ...
     */
    public kg.tasks.modules.ws.cbr.MrrfXMLResponseMrrfXMLResult getMrrfXMLResult() {
        return mrrfXMLResult;
    }
     ...
     * @param mrrfXMLResult
     */
    public void setMrrfXMLResult(kg.tasks.modules.ws.cbr.MrrfXMLResponseMrrfXMLResult mrrfXMLResult) {
        this.mrrfXMLResult = mrrfXMLResult;
    }
