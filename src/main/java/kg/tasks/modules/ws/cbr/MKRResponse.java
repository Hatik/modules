...
public class MKRResponse  implements java.io.Serializable {
    private kg.tasks.modules.ws.cbr.MKRResponseMKRResult MKRResult;

    public MKRResponse() {
    }

    public MKRResponse(
           kg.tasks.modules.ws.cbr.MKRResponseMKRResult MKRResult) {
     ...
     * @return MKRResult
     */
    public kg.tasks.modules.ws.cbr.MKRResponseMKRResult getMKRResult() {
        return MKRResult;
    }
     ...
     * @param MKRResult
     */
    public void setMKRResult(kg.tasks.modules.ws.cbr.MKRResponseMKRResult MKRResult) {
        this.MKRResult = MKRResult;
    }
