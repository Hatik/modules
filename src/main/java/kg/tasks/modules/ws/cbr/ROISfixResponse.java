...
public class ROISfixResponse  implements java.io.Serializable {
    private kg.tasks.modules.ws.cbr.ROISfixResponseROISfixResult ROISfixResult;

    public ROISfixResponse() {
    }

    public ROISfixResponse(
           kg.tasks.modules.ws.cbr.ROISfixResponseROISfixResult ROISfixResult) {
     ...
     */
    public kg.tasks.modules.ws.cbr.ROISfixResponseROISfixResult getROISfixResult() {
        return ROISfixResult;
    }
     ...
     * @param ROISfixResult
     */
    public void setROISfixResult(kg.tasks.modules.ws.cbr.ROISfixResponseROISfixResult ROISfixResult) {
        this.ROISfixResult = ROISfixResult;
    }
