...
public class SwapDynamicXMLResponse  implements java.io.Serializable {
    private kg.tasks.modules.ws.cbr.SwapDynamicXMLResponseSwapDynamicXMLResult swapDynamicXMLResult;

    public SwapDynamicXMLResponse() {
    }

    public SwapDynamicXMLResponse(
           kg.tasks.modules.ws.cbr.SwapDynamicXMLResponseSwapDynamicXMLResult swapDynamicXMLResult) {
     ...
     */
    public kg.tasks.modules.ws.cbr.SwapDynamicXMLResponseSwapDynamicXMLResult getSwapDynamicXMLResult() {
        return swapDynamicXMLResult;
    }
     ...
     */
    public void setSwapDynamicXMLResult(kg.tasks.modules.ws.cbr.SwapDynamicXMLResponseSwapDynamicXMLResult swapDynamicXMLResult) {
        this.swapDynamicXMLResult = swapDynamicXMLResult;
    }
