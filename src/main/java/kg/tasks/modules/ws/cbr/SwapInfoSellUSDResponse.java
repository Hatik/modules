...
public class SwapInfoSellUSDResponse  implements java.io.Serializable {
    private kg.tasks.modules.ws.cbr.SwapInfoSellUSDResponseSwapInfoSellUSDResult swapInfoSellUSDResult;

    public SwapInfoSellUSDResponse() {
    }

    public SwapInfoSellUSDResponse(
           kg.tasks.modules.ws.cbr.SwapInfoSellUSDResponseSwapInfoSellUSDResult swapInfoSellUSDResult) {
     ...
     */
    public kg.tasks.modules.ws.cbr.SwapInfoSellUSDResponseSwapInfoSellUSDResult getSwapInfoSellUSDResult() {
        return swapInfoSellUSDResult;
    }
     ...
     */
    public void setSwapInfoSellUSDResult(kg.tasks.modules.ws.cbr.SwapInfoSellUSDResponseSwapInfoSellUSDResult swapInfoSellUSDResult) {
        this.swapInfoSellUSDResult = swapInfoSellUSDResult;
    }
