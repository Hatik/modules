...
public class FixingBaseResponse  implements java.io.Serializable {
    private kg.tasks.modules.ws.cbr.FixingBaseResponseFixingBaseResult fixingBaseResult;

    public FixingBaseResponse() {
    }

    public FixingBaseResponse(
           kg.tasks.modules.ws.cbr.FixingBaseResponseFixingBaseResult fixingBaseResult) {
     ...
     */
    public kg.tasks.modules.ws.cbr.FixingBaseResponseFixingBaseResult getFixingBaseResult() {
        return fixingBaseResult;
    }
     ...
     */
    public void setFixingBaseResult(kg.tasks.modules.ws.cbr.FixingBaseResponseFixingBaseResult fixingBaseResult) {
        this.fixingBaseResult = fixingBaseResult;
    }
