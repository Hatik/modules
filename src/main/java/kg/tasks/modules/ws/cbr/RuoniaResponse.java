...
public class RuoniaResponse  implements java.io.Serializable {
    private kg.tasks.modules.ws.cbr.RuoniaResponseRuoniaResult ruoniaResult;

    public RuoniaResponse() {
    }

    public RuoniaResponse(
           kg.tasks.modules.ws.cbr.RuoniaResponseRuoniaResult ruoniaResult) {
     ...
     * @return ruoniaResult
     */
    public kg.tasks.modules.ws.cbr.RuoniaResponseRuoniaResult getRuoniaResult() {
        return ruoniaResult;
    }
     ...
     * @param ruoniaResult
     */
    public void setRuoniaResult(kg.tasks.modules.ws.cbr.RuoniaResponseRuoniaResult ruoniaResult) {
        this.ruoniaResult = ruoniaResult;
    }
