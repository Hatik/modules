...
public class OstatDynamicResponse  implements java.io.Serializable {
    private kg.tasks.modules.ws.cbr.OstatDynamicResponseOstatDynamicResult ostatDynamicResult;

    public OstatDynamicResponse() {
    }

    public OstatDynamicResponse(
           kg.tasks.modules.ws.cbr.OstatDynamicResponseOstatDynamicResult ostatDynamicResult) {
     ...
     */
    public kg.tasks.modules.ws.cbr.OstatDynamicResponseOstatDynamicResult getOstatDynamicResult() {
        return ostatDynamicResult;
    }
     ...
     */
    public void setOstatDynamicResult(kg.tasks.modules.ws.cbr.OstatDynamicResponseOstatDynamicResult ostatDynamicResult) {
        this.ostatDynamicResult = ostatDynamicResult;
    }
