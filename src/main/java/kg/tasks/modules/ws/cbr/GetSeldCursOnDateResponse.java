...
public class GetSeldCursOnDateResponse  implements java.io.Serializable {
    private kg.tasks.modules.ws.cbr.GetSeldCursOnDateResponseGetSeldCursOnDateResult getSeldCursOnDateResult;

    public GetSeldCursOnDateResponse() {
    }

    public GetSeldCursOnDateResponse(
           kg.tasks.modules.ws.cbr.GetSeldCursOnDateResponseGetSeldCursOnDateResult getSeldCursOnDateResult) {
     ...
     */
    public kg.tasks.modules.ws.cbr.GetSeldCursOnDateResponseGetSeldCursOnDateResult getGetSeldCursOnDateResult() {
        return getSeldCursOnDateResult;
    }
     ...
     */
    public void setGetSeldCursOnDateResult(kg.tasks.modules.ws.cbr.GetSeldCursOnDateResponseGetSeldCursOnDateResult getSeldCursOnDateResult) {
        this.getSeldCursOnDateResult = getSeldCursOnDateResult;
    }
