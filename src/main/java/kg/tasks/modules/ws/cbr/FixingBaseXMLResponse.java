...
public class FixingBaseXMLResponse  implements java.io.Serializable {
    private kg.tasks.modules.ws.cbr.FixingBaseXMLResponseFixingBaseXMLResult fixingBaseXMLResult;

    public FixingBaseXMLResponse() {
    }

    public FixingBaseXMLResponse(
           kg.tasks.modules.ws.cbr.FixingBaseXMLResponseFixingBaseXMLResult fixingBaseXMLResult) {
     ...
     */
    public kg.tasks.modules.ws.cbr.FixingBaseXMLResponseFixingBaseXMLResult getFixingBaseXMLResult() {
        return fixingBaseXMLResult;
    }
     ...
     */
    public void setFixingBaseXMLResult(kg.tasks.modules.ws.cbr.FixingBaseXMLResponseFixingBaseXMLResult fixingBaseXMLResult) {
        this.fixingBaseXMLResult = fixingBaseXMLResult;
    }
