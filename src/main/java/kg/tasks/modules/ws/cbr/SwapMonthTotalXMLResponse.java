...
public class SwapMonthTotalXMLResponse  implements java.io.Serializable {
    private kg.tasks.modules.ws.cbr.SwapMonthTotalXMLResponseSwapMonthTotalXMLResult swapMonthTotalXMLResult;

    public SwapMonthTotalXMLResponse() {
    }

    public SwapMonthTotalXMLResponse(
           kg.tasks.modules.ws.cbr.SwapMonthTotalXMLResponseSwapMonthTotalXMLResult swapMonthTotalXMLResult) {
     ...
     */
    public kg.tasks.modules.ws.cbr.SwapMonthTotalXMLResponseSwapMonthTotalXMLResult getSwapMonthTotalXMLResult() {
        return swapMonthTotalXMLResult;
    }
     ...
     */
    public void setSwapMonthTotalXMLResult(kg.tasks.modules.ws.cbr.SwapMonthTotalXMLResponseSwapMonthTotalXMLResult swapMonthTotalXMLResult) {
        this.swapMonthTotalXMLResult = swapMonthTotalXMLResult;
    }
