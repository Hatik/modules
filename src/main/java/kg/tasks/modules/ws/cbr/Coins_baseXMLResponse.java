...
public class Coins_baseXMLResponse  implements java.io.Serializable {
    private kg.tasks.modules.ws.cbr.Coins_baseXMLResponseCoins_baseXMLResult coins_baseXMLResult;

    public Coins_baseXMLResponse() {
    }

    public Coins_baseXMLResponse(
           kg.tasks.modules.ws.cbr.Coins_baseXMLResponseCoins_baseXMLResult coins_baseXMLResult) {
     ...
     */
    public kg.tasks.modules.ws.cbr.Coins_baseXMLResponseCoins_baseXMLResult getCoins_baseXMLResult() {
        return coins_baseXMLResult;
    }
     ...
     */
    public void setCoins_baseXMLResult(kg.tasks.modules.ws.cbr.Coins_baseXMLResponseCoins_baseXMLResult coins_baseXMLResult) {
        this.coins_baseXMLResult = coins_baseXMLResult;
    }
