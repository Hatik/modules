...
public class SaldoResponse  implements java.io.Serializable {
    private kg.tasks.modules.ws.cbr.SaldoResponseSaldoResult saldoResult;

    public SaldoResponse() {
    }

    public SaldoResponse(
           kg.tasks.modules.ws.cbr.SaldoResponseSaldoResult saldoResult) {
     ...
     * @return saldoResult
     */
    public kg.tasks.modules.ws.cbr.SaldoResponseSaldoResult getSaldoResult() {
        return saldoResult;
    }
     ...
     * @param saldoResult
     */
    public void setSaldoResult(kg.tasks.modules.ws.cbr.SaldoResponseSaldoResult saldoResult) {
        this.saldoResult = saldoResult;
    }
