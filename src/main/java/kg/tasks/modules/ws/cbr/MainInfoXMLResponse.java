...
public class MainInfoXMLResponse  implements java.io.Serializable {
    private kg.tasks.modules.ws.cbr.MainInfoXMLResponseMainInfoXMLResult mainInfoXMLResult;

    public MainInfoXMLResponse() {
    }

    public MainInfoXMLResponse(
           kg.tasks.modules.ws.cbr.MainInfoXMLResponseMainInfoXMLResult mainInfoXMLResult) {
     ...
     */
    public kg.tasks.modules.ws.cbr.MainInfoXMLResponseMainInfoXMLResult getMainInfoXMLResult() {
        return mainInfoXMLResult;
    }
     ...
     */
    public void setMainInfoXMLResult(kg.tasks.modules.ws.cbr.MainInfoXMLResponseMainInfoXMLResult mainInfoXMLResult) {
        this.mainInfoXMLResult = mainInfoXMLResult;
    }
