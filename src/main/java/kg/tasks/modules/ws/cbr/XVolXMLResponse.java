...
public class XVolXMLResponse  implements java.io.Serializable {
    private kg.tasks.modules.ws.cbr.XVolXMLResponseXVolXMLResult XVolXMLResult;

    public XVolXMLResponse() {
    }

    public XVolXMLResponse(
           kg.tasks.modules.ws.cbr.XVolXMLResponseXVolXMLResult XVolXMLResult) {
     ...
     */
    public kg.tasks.modules.ws.cbr.XVolXMLResponseXVolXMLResult getXVolXMLResult() {
        return XVolXMLResult;
    }
     ...
     * @param XVolXMLResult
     */
    public void setXVolXMLResult(kg.tasks.modules.ws.cbr.XVolXMLResponseXVolXMLResult XVolXMLResult) {
        this.XVolXMLResult = XVolXMLResult;
    }
