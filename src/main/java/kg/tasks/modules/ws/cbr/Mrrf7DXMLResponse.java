...
public class Mrrf7DXMLResponse  implements java.io.Serializable {
    private kg.tasks.modules.ws.cbr.Mrrf7DXMLResponseMrrf7DXMLResult mrrf7DXMLResult;

    public Mrrf7DXMLResponse() {
    }

    public Mrrf7DXMLResponse(
           kg.tasks.modules.ws.cbr.Mrrf7DXMLResponseMrrf7DXMLResult mrrf7DXMLResult) {
     ...
     */
    public kg.tasks.modules.ws.cbr.Mrrf7DXMLResponseMrrf7DXMLResult getMrrf7DXMLResult() {
        return mrrf7DXMLResult;
    }
     ...
     */
    public void setMrrf7DXMLResult(kg.tasks.modules.ws.cbr.Mrrf7DXMLResponseMrrf7DXMLResult mrrf7DXMLResult) {
        this.mrrf7DXMLResult = mrrf7DXMLResult;
    }
