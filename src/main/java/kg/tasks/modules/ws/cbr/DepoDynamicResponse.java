...
public class DepoDynamicResponse  implements java.io.Serializable {
    private kg.tasks.modules.ws.cbr.DepoDynamicResponseDepoDynamicResult depoDynamicResult;

    public DepoDynamicResponse() {
    }

    public DepoDynamicResponse(
           kg.tasks.modules.ws.cbr.DepoDynamicResponseDepoDynamicResult depoDynamicResult) {
     ...
     */
    public kg.tasks.modules.ws.cbr.DepoDynamicResponseDepoDynamicResult getDepoDynamicResult() {
        return depoDynamicResult;
    }
     ...
     */
    public void setDepoDynamicResult(kg.tasks.modules.ws.cbr.DepoDynamicResponseDepoDynamicResult depoDynamicResult) {
        this.depoDynamicResult = depoDynamicResult;
    }
