...
public class OvernightXMLResponse  implements java.io.Serializable {
    private kg.tasks.modules.ws.cbr.OvernightXMLResponseOvernightXMLResult overnightXMLResult;

    public OvernightXMLResponse() {
    }

    public OvernightXMLResponse(
           kg.tasks.modules.ws.cbr.OvernightXMLResponseOvernightXMLResult overnightXMLResult) {
     ...
     */
    public kg.tasks.modules.ws.cbr.OvernightXMLResponseOvernightXMLResult getOvernightXMLResult() {
        return overnightXMLResult;
    }
     ...
     */
    public void setOvernightXMLResult(kg.tasks.modules.ws.cbr.OvernightXMLResponseOvernightXMLResult overnightXMLResult) {
        this.overnightXMLResult = overnightXMLResult;
    }
