...
public class NewsInfoXMLResponse  implements java.io.Serializable {
    private kg.tasks.modules.ws.cbr.NewsInfoXMLResponseNewsInfoXMLResult newsInfoXMLResult;

    public NewsInfoXMLResponse() {
    }

    public NewsInfoXMLResponse(
           kg.tasks.modules.ws.cbr.NewsInfoXMLResponseNewsInfoXMLResult newsInfoXMLResult) {
     ...
     */
    public kg.tasks.modules.ws.cbr.NewsInfoXMLResponseNewsInfoXMLResult getNewsInfoXMLResult() {
        return newsInfoXMLResult;
    }
     ...
     */
    public void setNewsInfoXMLResult(kg.tasks.modules.ws.cbr.NewsInfoXMLResponseNewsInfoXMLResult newsInfoXMLResult) {
        this.newsInfoXMLResult = newsInfoXMLResult;
    }
