...
public class Mrrf7DResponse  implements java.io.Serializable {
    private kg.tasks.modules.ws.cbr.Mrrf7DResponseMrrf7DResult mrrf7DResult;

    public Mrrf7DResponse() {
    }

    public Mrrf7DResponse(
           kg.tasks.modules.ws.cbr.Mrrf7DResponseMrrf7DResult mrrf7DResult) {
     ...
     * @return mrrf7DResult
     */
    public kg.tasks.modules.ws.cbr.Mrrf7DResponseMrrf7DResult getMrrf7DResult() {
        return mrrf7DResult;
    }
     ...
     * @param mrrf7DResult
     */
    public void setMrrf7DResult(kg.tasks.modules.ws.cbr.Mrrf7DResponseMrrf7DResult mrrf7DResult) {
        this.mrrf7DResult = mrrf7DResult;
    }
