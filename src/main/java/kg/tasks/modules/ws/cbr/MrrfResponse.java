...
public class MrrfResponse  implements java.io.Serializable {
    private kg.tasks.modules.ws.cbr.MrrfResponseMrrfResult mrrfResult;

    public MrrfResponse() {
    }

    public MrrfResponse(
           kg.tasks.modules.ws.cbr.MrrfResponseMrrfResult mrrfResult) {
     ...
     * @return mrrfResult
     */
    public kg.tasks.modules.ws.cbr.MrrfResponseMrrfResult getMrrfResult() {
        return mrrfResult;
    }
     ...
     * @param mrrfResult
     */
    public void setMrrfResult(kg.tasks.modules.ws.cbr.MrrfResponseMrrfResult mrrfResult) {
        this.mrrfResult = mrrfResult;
    }
