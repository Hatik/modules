...
public class SwapInfoSellUSDXMLResponse  implements java.io.Serializable {
    private kg.tasks.modules.ws.cbr.SwapInfoSellUSDXMLResponseSwapInfoSellUSDXMLResult swapInfoSellUSDXMLResult;

    public SwapInfoSellUSDXMLResponse() {
    }

    public SwapInfoSellUSDXMLResponse(
           kg.tasks.modules.ws.cbr.SwapInfoSellUSDXMLResponseSwapInfoSellUSDXMLResult swapInfoSellUSDXMLResult) {
     ...
     */
    public kg.tasks.modules.ws.cbr.SwapInfoSellUSDXMLResponseSwapInfoSellUSDXMLResult getSwapInfoSellUSDXMLResult() {
        return swapInfoSellUSDXMLResult;
    }
     ...
     */
    public void setSwapInfoSellUSDXMLResult(kg.tasks.modules.ws.cbr.SwapInfoSellUSDXMLResponseSwapInfoSellUSDXMLResult swapInfoSellUSDXMLResult) {
        this.swapInfoSellUSDXMLResult = swapInfoSellUSDXMLResult;
    }
