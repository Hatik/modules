...
public class OmodInfoXMLResponse  implements java.io.Serializable {
    private kg.tasks.modules.ws.cbr.OmodInfoXMLResponseOmodInfoXMLResult omodInfoXMLResult;

    public OmodInfoXMLResponse() {
    }

    public OmodInfoXMLResponse(
           kg.tasks.modules.ws.cbr.OmodInfoXMLResponseOmodInfoXMLResult omodInfoXMLResult) {
     ...
     */
    public kg.tasks.modules.ws.cbr.OmodInfoXMLResponseOmodInfoXMLResult getOmodInfoXMLResult() {
        return omodInfoXMLResult;
    }
     ...
     */
    public void setOmodInfoXMLResult(kg.tasks.modules.ws.cbr.OmodInfoXMLResponseOmodInfoXMLResult omodInfoXMLResult) {
        this.omodInfoXMLResult = omodInfoXMLResult;
    }
