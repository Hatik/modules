...
public class OstatDepoXMLResponse  implements java.io.Serializable {
    private kg.tasks.modules.ws.cbr.OstatDepoXMLResponseOstatDepoXMLResult ostatDepoXMLResult;

    public OstatDepoXMLResponse() {
    }

    public OstatDepoXMLResponse(
           kg.tasks.modules.ws.cbr.OstatDepoXMLResponseOstatDepoXMLResult ostatDepoXMLResult) {
     ...
     */
    public kg.tasks.modules.ws.cbr.OstatDepoXMLResponseOstatDepoXMLResult getOstatDepoXMLResult() {
        return ostatDepoXMLResult;
    }
     ...
     */
    public void setOstatDepoXMLResult(kg.tasks.modules.ws.cbr.OstatDepoXMLResponseOstatDepoXMLResult ostatDepoXMLResult) {
        this.ostatDepoXMLResult = ostatDepoXMLResult;
    }
