...
public class AllDataInfoXMLResponse  implements java.io.Serializable {
    private kg.tasks.modules.ws.cbr.AllDataInfoXMLResponseAllDataInfoXMLResult allDataInfoXMLResult;

    public AllDataInfoXMLResponse() {
    }

    public AllDataInfoXMLResponse(
           kg.tasks.modules.ws.cbr.AllDataInfoXMLResponseAllDataInfoXMLResult allDataInfoXMLResult) {
     ...
     */
    public kg.tasks.modules.ws.cbr.AllDataInfoXMLResponseAllDataInfoXMLResult getAllDataInfoXMLResult() {
        return allDataInfoXMLResult;
    }
     ...
     */
    public void setAllDataInfoXMLResult(kg.tasks.modules.ws.cbr.AllDataInfoXMLResponseAllDataInfoXMLResult allDataInfoXMLResult) {
        this.allDataInfoXMLResult = allDataInfoXMLResult;
    }
