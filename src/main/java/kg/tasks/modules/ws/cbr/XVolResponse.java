...
public class XVolResponse  implements java.io.Serializable {
    private kg.tasks.modules.ws.cbr.XVolResponseXVolResult XVolResult;

    public XVolResponse() {
    }

    public XVolResponse(
           kg.tasks.modules.ws.cbr.XVolResponseXVolResult XVolResult) {
     ...
     * @return XVolResult
     */
    public kg.tasks.modules.ws.cbr.XVolResponseXVolResult getXVolResult() {
        return XVolResult;
    }
     ...
     * @param XVolResult
     */
    public void setXVolResult(kg.tasks.modules.ws.cbr.XVolResponseXVolResult XVolResult) {
        this.XVolResult = XVolResult;
    }
