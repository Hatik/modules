...
public class EnumValutesXMLResponse  implements java.io.Serializable {
    private kg.tasks.modules.ws.cbr.EnumValutesXMLResponseEnumValutesXMLResult enumValutesXMLResult;

    public EnumValutesXMLResponse() {
    }

    public EnumValutesXMLResponse(
           kg.tasks.modules.ws.cbr.EnumValutesXMLResponseEnumValutesXMLResult enumValutesXMLResult) {
     ...
     */
    public kg.tasks.modules.ws.cbr.EnumValutesXMLResponseEnumValutesXMLResult getEnumValutesXMLResult() {
        return enumValutesXMLResult;
    }
     ...
     */
    public void setEnumValutesXMLResult(kg.tasks.modules.ws.cbr.EnumValutesXMLResponseEnumValutesXMLResult enumValutesXMLResult) {
        this.enumValutesXMLResult = enumValutesXMLResult;
    }
