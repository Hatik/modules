...
public class DVResponse  implements java.io.Serializable {
    private kg.tasks.modules.ws.cbr.DVResponseDVResult DVResult;

    public DVResponse() {
    }

    public DVResponse(
           kg.tasks.modules.ws.cbr.DVResponseDVResult DVResult) {
     ...
     * @return DVResult
     */
    public kg.tasks.modules.ws.cbr.DVResponseDVResult getDVResult() {
        return DVResult;
    }
     ...
     * @param DVResult
     */
    public void setDVResult(kg.tasks.modules.ws.cbr.DVResponseDVResult DVResult) {
        this.DVResult = DVResult;
    }
