...
public class EnumValutesResponse  implements java.io.Serializable {
    private kg.tasks.modules.ws.cbr.EnumValutesResponseEnumValutesResult enumValutesResult;

    public EnumValutesResponse() {
    }

    public EnumValutesResponse(
           kg.tasks.modules.ws.cbr.EnumValutesResponseEnumValutesResult enumValutesResult) {
     ...
     */
    public kg.tasks.modules.ws.cbr.EnumValutesResponseEnumValutesResult getEnumValutesResult() {
        return enumValutesResult;
    }
     ...
     */
    public void setEnumValutesResult(kg.tasks.modules.ws.cbr.EnumValutesResponseEnumValutesResult enumValutesResult) {
        this.enumValutesResult = enumValutesResult;
    }
